...
class XCELSetStartProcessingMethod :public XCELProcessingMethod
{
public:
~XCELSetStartProcessingMethod(){};
XCELSetStartProcessingMethod(){trigger="setStartPosition";}
   ...
   //     const QString& getTrigger();
    ...
    // ### no return-value now, so set to void
