...
class XCELValueIsNotInIndexProcessingMethod : public XCELProcessingMethod
{
public:
  ~XCELValueIsNotInIndexProcessingMethod(){};
   XCELValueIsNotInIndexProcessingMethod(){trigger="valueIsNotInIndex";}
