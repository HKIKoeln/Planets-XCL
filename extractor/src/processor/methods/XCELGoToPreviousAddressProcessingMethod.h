...
class XCELGoToPreviousAddressProcessingMethod :public XCELProcessingMethod
{
public:
~XCELGoToPreviousAddressProcessingMethod(){};
XCELGoToPreviousAddressProcessingMethod(){trigger="goToPreviousAddress";}
