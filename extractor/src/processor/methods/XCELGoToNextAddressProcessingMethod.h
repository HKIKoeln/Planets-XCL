...
class XCELGoToNextAddressProcessingMethod :public XCELProcessingMethod
{
public:
~XCELGoToNextAddressProcessingMethod(){};
XCELGoToNextAddressProcessingMethod(){trigger="goToNextAddress";}
