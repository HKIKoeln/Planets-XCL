...
class XCELGoToLastAddressProcessingMethod :public XCELProcessingMethod
{
public:
~XCELGoToLastAddressProcessingMethod(){};
XCELGoToLastAddressProcessingMethod(){trigger="goToLastAddress";}
