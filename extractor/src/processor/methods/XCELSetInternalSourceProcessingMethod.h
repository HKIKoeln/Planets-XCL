...
class XCELSetInternalSourceProcessingMethod :public XCELProcessingMethod
{
public:
~XCELSetInternalSourceProcessingMethod(){};
XCELSetInternalSourceProcessingMethod(){trigger="setInternalSource";}
