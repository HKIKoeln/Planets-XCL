...
class XCELSetAddrSchemeProcessingMethod :public XCELProcessingMethod
{
public:
~XCELSetAddrSchemeProcessingMethod(){};
XCELSetAddrSchemeProcessingMethod(){trigger="setAddressingScheme";}
