...
class XCELGetItemNumberProcessingMethod :public XCELProcessingMethod
{
public:
~XCELGetItemNumberProcessingMethod(){};
XCELGetItemNumberProcessingMethod(){trigger="getItemNumber";}
