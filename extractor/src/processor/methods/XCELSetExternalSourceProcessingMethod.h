...
class XCELSetExternalSourceProcessingMethod :public XCELProcessingMethod
{
public:
~XCELSetExternalSourceProcessingMethod(){};
XCELSetExternalSourceProcessingMethod(){trigger="setExternalSource";}
