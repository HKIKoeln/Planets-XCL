...
class XCELSetInterpretationProcessingMethod :public XCELProcessingMethod
{
public:
~XCELSetInterpretationProcessingMethod(){};
XCELSetInterpretationProcessingMethod(){trigger="setInterpretation";}
