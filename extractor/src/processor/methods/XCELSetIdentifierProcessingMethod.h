...
class XCELSetIdentifierProcessingMethod :public XCELProcessingMethod
{
public:
~XCELSetIdentifierProcessingMethod(){};
XCELSetIdentifierProcessingMethod(){trigger="setIdentifier";}
