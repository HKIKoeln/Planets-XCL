...
class XCELSetByteOrderProcessingMethod :public XCELProcessingMethod
{
public:
~XCELSetByteOrderProcessingMethod(){};
XCELSetByteOrderProcessingMethod(){trigger="setByteOrder";}
